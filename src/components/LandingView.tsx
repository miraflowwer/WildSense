  ...
  const handleEnterDemo = async () => {
    ...
    try {
      if (onReturnToDashboard && mode === 'demo') {
        ...
        await signIn('demo@gahm.org', 'demo1234')
      }
    } finally {
      setDemoBusy(false)
    }
    ...
    <div className="relative min-h-dvh bg-[#FDFBF7] font-sans text-[#1A202C] selection:bg-[#123524] selection:text-white">
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-bold text-[#C05621]">
                Global Actions on Habitats and Marines
              </span>
            </div>

            {/* Target SDG 15 Badge */}
            <span className="hidden items-center gap-1.5 rounded-full border border-[#123524]/20 bg-[#123524]/10 px-3 py-1 text-xs font-bold text-[#123524] sm:inline-flex">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {mode ? (
              <button
                ...
                className="rounded-xl border border-[#123524] bg-[#123524] px-4 py-2 text-xs font-bold text-white shadow-sm transition-colors hover:bg-[#1B4D3E] sm:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
              >
                Return to Dashboard →
              </button>
            ) : (
              <>
                <button
                  ...
                  className="rounded-xl border border-[#E8E2D5] bg-white px-4 py-2 text-xs font-bold text-[#1A202C] shadow-xs transition-colors hover:bg-[#F6F2EA] sm:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
                >
                  Log in
                </button>
                <button
                  ...
                  className="rounded-xl bg-[#123524] px-4 py-2 text-xs font-bold text-white shadow-sm transition-colors hover:bg-[#1B4D3E] sm:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
                >
                  Register
                </button>
                <button
                  ...
                  disabled={demoBusy}
                  className="hidden rounded-xl border border-[#C05621] bg-[#C05621]/10 px-4 py-2 text-xs font-bold text-[#C05621] transition-colors hover:bg-[#C05621] hover:text-white sm:inline-block sm:text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C05621] disabled:opacity-50"
                >
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 space-y-28">
        ...
        <section ref={heroRef} className="relative pt-6 text-center lg:pt-14 space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#123524]/20 bg-white/80 backdrop-blur-xs px-4 py-1.5 text-xs font-bold text-[#123524] shadow-xs">
          ...
          <p className="mx-auto max-w-2xl text-base leading-relaxed text-neutral-700 sm:text-lg">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4 pt-2">
            <button
              ...
              onClick={() => void handleEnterDemo()}
              disabled={demoBusy}
              className="w-full rounded-xl bg-[#123524] px-7 py-3.5 text-sm font-bold text-white shadow-md transition-all hover:bg-[#1B4D3E] sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524] disabled:opacity-50"
            >
            ...
            <button
              type="button"
              onClick={() => setAuthModal({ open: true, view: 'signup' })}
              className="w-full rounded-xl border border-[#E8E2D5] bg-white px-7 py-3.5 text-sm font-bold text-[#1A202C] shadow-xs transition-all hover:bg-[#F6F2EA] sm:w-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
            >
              Create Account
            </button>
          </div>
          ...
          <div className="mt-14 grid grid-cols-2 gap-4 rounded-3xl border border-[#E8E2D5] bg-white/90 p-6 shadow-xl backdrop-blur-md sm:grid-cols-4 sm:p-8">
            <div className="space-y-1 border-r border-[#E8E2D5]/60 pr-2">
              ...
              <div className="text-[11px] text-neutral-600">Ranger Patrol Control</div>
            </div>
            ...
            <div className="space-y-1 border-r border-[#E8E2D5]/60 pr-2">
              ...
              <div className="text-[11px] text-neutral-600">Anti-Poaching Protection</div>
            </div>
            ...
            <div className="space-y-1 border-r border-[#E8E2D5]/60 pr-2">
              ...
              <div className="text-[11px] text-neutral-600">Habitat Preservation</div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="text-[11px] text-neutral-600">Transparent 0–100 Scoring</div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="text-center space-y-2">
            <span className="text-xs font-bold uppercase tracking-widest text-[#C05621]">
              Interactive Scroll Deck
            </span>
            ...
            <p className="text-sm text-neutral-600 max-w-lg mx-auto">
              Scroll down to step through GAHM’s end-to-end conflict prediction and non-lethal dispatch modules.
            </p>
          </div>
        ...
        <section ref={sdgRef} className="rounded-3xl border border-[#E8E2D5] bg-white/90 p-8 sm:p-12 shadow-xl backdrop-blur-md space-y-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-[#E8E2D5] pb-6">
            <div>
              <span className="inline-block rounded-full bg-[#123524]/10 px-3.5 py-1 text-xs font-bold text-[#123524] mb-2 border border-[#123524]/20">
            ...
            <div className="text-xs text-neutral-600 md:text-right max-w-xs leading-relaxed">
              Protecting terrestrial biodiversity, mitigating fringe agriculture encounters, and preventing retaliatory wildlife harm.
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs leading-relaxed text-neutral-700">
            <div className="space-y-2.5 rounded-2xl border border-[#E8E2D5] bg-[#FDFBF7] p-6 shadow-xs">
              <h3 className="text-sm font-bold text-[#123524]">Habitat Boundary Protection</h3>
              <p>
            ...
            <div className="space-y-2.5 rounded-2xl border border-[#E8E2D5] bg-[#FDFBF7] p-6 shadow-xs">
              <h3 className="text-sm font-bold text-[#C05621]">Non-Lethal Early Warning</h3>
              <p>
            ...
            <div className="space-y-2.5 rounded-2xl border border-[#E8E2D5] bg-[#FDFBF7] p-6 shadow-xs">
              <h3 className="text-sm font-bold text-[#123524]">Schedule I Wildlife Focus</h3>
              <p>
        ...
        <section className="space-y-24">
          ...
          >
            ...
            <div className="persona-text lg:col-span-6 space-y-6 relative z-10">
              <span className="inline-flex items-center gap-2 rounded-full bg-[#123524]/10 px-3.5 py-1 text-xs font-bold text-[#123524]">
              ...
              <ul className="space-y-3 text-xs font-medium text-neutral-800">
                <li className="flex items-center gap-2.5">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#123524] text-white text-[10px] font-bold">✓</span>
              ...
              <button
                type="button"
                onClick={() => void handleEnterDemo()}
                className="inline-flex items-center gap-2 rounded-xl bg-[#123524] px-5 py-2.5 text-xs font-bold text-white transition-colors hover:bg-[#1B4D3E]"
              >
            ...
            <div className="persona-image lg:col-span-6 relative z-10">
              <div className="relative overflow-hidden rounded-2xl border border-[#E8E2D5] shadow-lg">
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-xl bg-white/90 p-4 backdrop-blur-md border border-[#E8E2D5] shadow-md">
                  <div className="text-xs font-bold text-[#123524]">Ranger Field Dashboard Preview</div>
                  <div className="text-[11px] text-neutral-600">EVT-1042 · Asian Elephant Herd (420m to North Farm)</div>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="persona-image lg:col-span-6 lg:order-1 relative z-10">
              <div className="relative overflow-hidden rounded-2xl border border-[#E8E2D5] shadow-lg">
                ...
                />
                <div className="absolute bottom-4 left-4 right-4 rounded-xl bg-white/90 p-4 backdrop-blur-md border border-[#E8E2D5] shadow-md">
                  <div className="text-xs font-bold text-[#C05621]">Risk Algorithm Weights (25/20/15/15/10/10/5)</div>
                  <div className="text-[11px] text-neutral-600">Proximity (25%), Movement (20%), Species (15%), History (15%)</div>
                </div>
              </div>
            </div>

            <div className="persona-text lg:col-span-6 lg:order-2 space-y-6 relative z-10">
              <span className="inline-flex items-center gap-2 rounded-full bg-[#C05621]/10 px-3.5 py-1 text-xs font-bold text-[#C05621]">
              ...
              <ul className="space-y-3 text-xs font-medium text-neutral-800">
                <li className="flex items-center gap-2.5">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[#C05621] text-white text-[10px] font-bold">✓</span>
              ...
              <button
                type="button"
                onClick={() => void handleEnterDemo()}
                className="inline-flex items-center gap-2 rounded-xl bg-[#C05621] px-5 py-2.5 text-xs font-bold text-white transition-colors hover:bg-[#A04518]"
              >
          ...
          >
            ...
            <div className="persona-image lg:col-span-6 relative z-10">
              <div className="relative overflow-hidden rounded-2xl border border-[#E8E2D5] shadow-lg">
                ...
                />
                <div className="absolute bottom-4 left-4 right-4 rounded-xl bg-white/90 p-4 backdrop-blur-md border border-[#E8E2D5] shadow-md">
                  <div className="text-xs font-bold text-[#123524]">Simulated SMS Alert Message</div>
                  <div className="text-[11px] text-neutral-600">GAHM ALERT: High elephant risk near North Farm. Avoid field boundary until 21:00 UTC. Reply STOP to opt out.</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section ref={ethicsRef} className="rounded-3xl border border-[#E8E2D5] bg-white/95 p-8 sm:p-12 shadow-2xl backdrop-blur-md space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E8E2D5] pb-6">
            ...
            <button
              ...
              className="rounded-xl border border-[#E8E2D5] bg-[#FDFBF7] px-4 py-2 text-xs font-bold text-[#123524] hover:bg-[#F6F2EA] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
            >
        ...
        <section className="rounded-3xl border border-[#E8E2D5] bg-white/95 p-8 sm:p-10 shadow-lg space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-extrabold text-[#123524]">Universal Accessibility Guarantee</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-neutral-700 pt-2">
            <div className="flex items-start gap-3">
              <span className="font-bold text-[#123524]">✓</span>
              <div>
                <strong className="text-[#123524] block text-sm">Deaf &amp; Hearing-Impaired Accessibility</strong>
            ...
            <div className="flex items-start gap-3">
              <span className="font-bold text-[#123524]">✓</span>
              <div>
                <strong className="text-[#123524] block text-sm">Mobile &amp; Touch Friendly Design</strong>
        ...
        <footer className="border-t border-[#E8E2D5] pt-12 pb-10 text-center space-y-8">
          <div className="max-w-xl mx-auto space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <button
                ...
                onClick={() => void handleEnterDemo()}
                disabled={demoBusy}
                className="w-full sm:w-auto rounded-xl bg-[#123524] px-7 py-3 text-sm font-bold text-white hover:bg-[#1B4D3E] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524] disabled:opacity-50"
              >
                {demoBusy ? 'Launching…' : 'Try Live Demo'}
              </button>
              <button
                type="button"
                onClick={() => setAuthModal({ open: true, view: 'signup' })}
                className="w-full sm:w-auto rounded-xl border border-[#E8E2D5] bg-white px-7 py-3 text-sm font-bold text-[#1A202C] hover:bg-[#F6F2EA] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
              >
          ...
          <div className="border-t border-[#E8E2D5] pt-8 text-xs text-neutral-500 space-y-1.5">
            <div>
